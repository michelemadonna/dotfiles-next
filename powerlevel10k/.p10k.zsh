...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    context                 # SSH/root/session indicator
  ...
  # Formatter for Git status. Keep this in sync with the Git template in
  # oh-my-posh/custom.omp.json.
  #
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # Oh My Posh uses `trunc 25 .Branch`.
      (( $#branch > 25 )) && branch="${branch[1,24]}…"
    ...
    # Same BranchStatus representation as Oh My Posh: identical, behind,
    # ahead, or diverged.
    ...
    # Oh My Posh groups worktree and index changes and prefixes each group
    # with its own icon. gitstatus doesn't expose every porcelain subtype,
    # so tracked worktree changes use `~` and staged changes use `+`.
    local working
    (( VCS_STATUS_NUM_CONFLICTED )) && working+="x${VCS_STATUS_NUM_CONFLICTED}"
    (( VCS_STATUS_NUM_UNSTAGED   )) && working+="~${VCS_STATUS_NUM_UNSTAGED}"
    (( VCS_STATUS_NUM_UNTRACKED  )) && working+="${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}${VCS_STATUS_NUM_UNTRACKED}"
    (( VCS_STATUS_HAS_UNSTAGED == -1 )) && working+='─'
    [[ -n $working ]] && res+=" ${modified} ${working}"
  ...
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#262B44'
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#F3AE35'
  typeset -g POWERLEVEL9K_OS_ICON_LEFT_LEFT_WHITESPACE=
  typeset -g POWERLEVEL9K_OS_ICON_LEFT_SEGMENT_SEPARATOR='%k\uE0B0'
  ...
  typeset -g POWERLEVEL9K_DIR_PREFIX='%k%F{#F07623}%S\uE0B0%s%K{#F07623} '
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=truncate_to_first_and_last
  typeset -g POWERLEVEL9K_SHORTEN_DELIMITER='..'
  typeset -g POWERLEVEL9K_SHORTEN_DIR_LENGTH=1
  typeset -g POWERLEVEL9K_DIR_ANCHOR_BOLD=false
  unset POWERLEVEL9K_DIR_SHORTENED_FOREGROUND POWERLEVEL9K_DIR_ANCHOR_FOREGROUND

  # P10k emits one `..` for every hidden directory, whereas agnoster_short
  # emits a single folder marker regardless of depth. Build a self-contained
  # prompt expansion so the directory is also available in instant prompt.
  local omp_dir_content='${P9K_CONTENT}'
  repeat 8; do
    omp_dir_content='${'${omp_dir_content}'//\/..\/../${:-/..}}'
  done
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_BACKGROUND='#4B95E9'
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND='#E0DEF4'
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND='#4B95E9'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%k%F{#4B95E9}%S\uE0B0%s%K{#4B95E9} '

  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#59C9A5'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#F3AE35'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND='#E0DEF4'
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND='#61CE41'
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND='#E0DEF4'
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_BACKGROUND='#61CE41'
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND='#E0DEF4'
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND='#D81E5B'
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND='#E0DEF4'
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND='#D81E5B'
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND='#E0DEF4'
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND='#D81E5B'
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION=$'\uF00C'
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_VISUAL_IDENTIFIER_EXPANSION=$'\uF00C'
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION=$'\uF00D'
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_VISUAL_IDENTIFIER_EXPANSION=$'\uF00D'
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_VISUAL_IDENTIFIER_EXPANSION=$'\uF00D'
  typeset -g POWERLEVEL9K_STATUS_RIGHT_LEFT_WHITESPACE=
  typeset -g POWERLEVEL9K_STATUS_{OK,OK_PIPE}_RIGHT_RIGHT_WHITESPACE=' %k%F{#61CE41}%S\uE0B2%s'
  typeset -g POWERLEVEL9K_STATUS_{ERROR,ERROR_SIGNAL,ERROR_PIPE}_RIGHT_RIGHT_WHITESPACE=' %k%F{#D81E5B}%S\uE0B2%s'

  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#262B44'
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND='#F3AE35'
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD=3
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PRECISION=0
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FORMAT='d h m s'
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_VISUAL_IDENTIFIER_EXPANSION='${${(M)TERM_PROGRAM:#iTerm.app}:+ }'
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_ICON_BEFORE_CONTENT=false
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_RIGHT_MIDDLE_WHITESPACE=
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_RIGHT_RIGHT_WHITESPACE=' %k%F{#F3AE35}%S\uE0B2%s'
  ...
  local omp_asdf_plugin
  for omp_asdf_plugin in dotnet_core elixir erlang flutter golang haskell java \
      julia lua nodejs perl php postgres python ruby rust; do
    typeset -g "POWERLEVEL9K_ASDF_${(U)omp_asdf_plugin}_FOREGROUND=#D81E5B"
    typeset -g "POWERLEVEL9K_ASDF_${(U)omp_asdf_plugin}_BACKGROUND=#E8E8E8"
    typeset -g "POWERLEVEL9K_ASDF_${(U)omp_asdf_plugin}_ICON_BEFORE_CONTENT=true"
    typeset -g "POWERLEVEL9K_ASDF_${(U)omp_asdf_plugin}_RIGHT_LEFT_WHITESPACE="
    typeset -g "POWERLEVEL9K_ASDF_${(U)omp_asdf_plugin}_RIGHT_RIGHT_WHITESPACE= %k%F{#E8E8E8}%S\uE0B2%s"
  done
  typeset -g POWERLEVEL9K_ASDF_PYTHON_VISUAL_IDENTIFIER_EXPANSION=$'\uE235'
  typeset -g POWERLEVEL9K_{VIRTUALENV,ANACONDA,PYENV}_VISUAL_IDENTIFIER_EXPANSION=$'\uE235'

  # Same final clock capsule as Oh My Posh.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND='#E0DEF4'
  typeset -g POWERLEVEL9K_TIME_BACKGROUND='#666666'
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%H:%M:%S}'
  typeset -g POWERLEVEL9K_TIME_VISUAL_IDENTIFIER_EXPANSION=$'\uE641'
  typeset -g POWERLEVEL9K_TIME_ICON_BEFORE_CONTENT=false
